---
name: rany-rejoin
description: Take back a RANY work-room seat this repository held before — no new invite link; this Gemini session is woken for it again.
---
...
has held that no other live Gemini session holds now.
...
```
node "$HOME/.rany-plugin/gemini/bridge.mjs" --rejoin [agentId]
```
